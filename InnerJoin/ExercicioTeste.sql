...
/*titulo*/
INNER JOIN livroautor ON livro.ID = livroautor.id_livro
/*nome do autor*/
INNER JOIN autor ON autor.ID = livroautor.id_autor

/*Genero*/
INNER JOIN livrocategoria ON livro.ID = livrocategoria.id_livro
INNER JOIN categoria ON categoria.ID = livrocategoria.id_categoria

/*nome do usuário que efetuou empréstimo*/
INNER JOIN emprestimo ON livro.ID = emprestimo.id_livro
INNER JOIN usuarioemprestimo ON usuarioemprestimo.id_emprestimo = emprestimo.ID
INNER JOIN usuario ON usuario.ID = usuarioemprestimo.id_usuario
